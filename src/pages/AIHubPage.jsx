...
const AIHubPage = () => {
  ...
  const filteredVideos = showHindiOnly 
    ? aiVideos.filter(video => video.language === 'Hindi')
    : aiVideos;

  const hindiCount = aiVideos.filter(v => v.language === 'Hindi').length;
  const totalCount = aiVideos.length;
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Master Artificial Intelligence with videos in Hindi and English
            </p>
          </motion.div>
        </div>
      </div>
